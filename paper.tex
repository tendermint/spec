...
%\begin{abstract}
%The paper introduces a formalization of the blockchain consensus problem and presents Tendermint, an %algorithm that achieves blockchain consensus within the partially synchronous system model.
%\end{abstract}
