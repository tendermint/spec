...
%\begin{abstract}
%The paper introduces a formalization of the blockchain consensus problem and presents Tendermint, and %algorithm that solves the blockchain consensus problem in the partially synchronous network model.
%\end{abstract}

%\noindent \textbf{Keywords:} Blockchain, Byzantine Fault Tolerance, PBFT, State Machine %Replication
